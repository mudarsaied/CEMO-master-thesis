...
\newcommand{\duo@page@i}{%
  \begin{titlepage}
    ...
    \null\par
    \vspace*{-0cm} % Used to be -2cm.
    %\vspace{1\baselineskip plus 3fill}
    \includegraphics[width=16cm]{./Figures/toppfelt-english}\par
    \vspace{2\baselineskip}
    {\fontsize{24}{28pt}\fontseries{sb}\selectfont \duo@title\par}
    \vspace{1\baselineskip}
    \ifx \duo@subtitle = \duo@empty
    \else
        {\fontsize{20}{25pt}\fontshape{sl}\selectfont \duo@subtitle\par}
