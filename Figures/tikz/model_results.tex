...
% Link input vars with mediators
    \draw[blue,->] (A1.east) to node[above,sloped,pos=0.57] {\press{0.285}{***}{0.018}} (fami1.west);
    \draw[blue,->] (A1.east) to node[above,sloped,pos=0.72] {\press{0.161}{***}{0.008}} (conf1.west);

    \draw[blue,->] (S1.east) to node[above,sloped,pos=0.33] {\press{0.055}{***}{0.006}} (fami1.west);
    \draw[blue,->,dashed] (S1.east) to node[below,sloped,pos=0.25] {\press{0.005}{}{0.009}} (conf1.west);

    \draw[blue,->] (C1.east) to node[below,sloped,pos=0.72] {\press{0.115}{***}{0.010}} (fami1.west);
    \draw[blue,->] (C1.east) to node[below,sloped,pos=0.57] {\press{0.153}{***}{0.008}} (conf1.west);

% Link mediators with outcome var
    \draw[blue,->] (fami1.east) to node[above,sloped,pos=0.55] {\press{0.195}{***}{0.014}} (flit1.west);
    \draw[blue,->] (conf1.east) to node[below,sloped,pos=0.55] {\press{0.080}{***}{0.010}} (flit1.west);

% Link input vars with outcome var
    \draw[red,->] (A1.east) to node[above,sloped,pos=0.45] {\press{-0.078}{***}{0.014}} (flit1.west);
    \draw[red,->] (S1.east) to node[above,sloped,pos=0.45] {\press{0.071}{***}{0.008}} (flit1.west);
    \draw[red,->,dashed] (C1.east) to node[above,sloped,pos=0.45] {\press{-0.004}{}{0.013}} (flit1.west);
...
% Link control vars with outcome var
    \draw[->] (escs.west) to node[above,sloped,pos=0.45] {\press{0.209}{***}{0.020}} (flit1.north east);
    \draw[->] (male.west) to node[below,sloped,pos=0.4] {\press{0.025}{*}{0.012}} (flit1.north east);
    \draw[->] (immi1.west) to node[above,sloped,pos=0.4] {\press{-0.039}{*}{0.015}} (flit1.south east);
    \draw[->] (immi2.west) to node[below,sloped,pos=0.45] {\press{-0.023}{*}{0.010}} (flit1.south east);
...
% Arc covariances
    \draw[<->] (A1.south) to [bend right] node[above,sloped] {\press{-0.051}{***}{0.009}} (S1.north);
    \draw[<->] (S1.south) to [bend right] node[above,sloped] {\press{-0.033}{***}{0.007}} (C1.north);
    \draw[<->] (A1.south) to [bend left] node[below,sloped,pos=0.25,rotate=180] {\press{0.230}{***}{0.013}} (C1.north);

    \draw[<->] (fami1.south) to [bend right] node[above,sloped] {\press{0.205}{***}{0.014}} (conf1.north);
